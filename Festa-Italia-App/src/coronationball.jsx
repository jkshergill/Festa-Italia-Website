    ...
    return (
        ...
        <main className= "flex-1 p-6 flex flex-col space-y-8">
         ...
         <div className="flex flex-col md:flex-row md:space-x-6">
            ...
            {/* first box*/}
            <div className= "flex-1  bg-white rounded-1g shadow p-4 mb-4 md:mb-0">
         ...
         <div className= "w-full h-60 bg-gray-200 rounded flex items-center justify-center mb-4">
          ...
          {/*Buy Tickets*/}
          <div className= "w-full md:w-1/3 bg-white rounded-1g shadow p-4">
        ...
        <div className="flex flex-col md:flex-row md:space-x-6 items-start"> 
           ...
           {/* gallery */}
           <div className= "flex-1  bg-pink rounded-1g shadow p-4 mb-4 md:mb-0">
